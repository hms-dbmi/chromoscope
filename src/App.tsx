...
import insertions_interactions_1 from './script/img/popover-images/insertions/interactions_1.png';
import deletions_interpretation_1 from './script/img/popover-images/deletions/interpretation_1.png';
import deletions_interpretation_2 from './script/img/popover-images/deletions/interpretation_2.png';
...
function App(props: RouteComponentProps) {
    ...
    const trackTooltips = useMemo(() => {
        ...
        const TRACK_HEIGHTS: { height: number; type: Track; title: string; popover_content?: string }[] = [
            {
                height: 50,
                type: 'ideogram',
                title: 'Ideogram',
