                            ...
                            <div className="upload-modal-header">
                                ...
                                >
                                    ...
                                    <input
                                        type="text"
                                        className={
                                            testOkay.id(sampleConfig) ? 'menu-text-input' : 'menu-text-input-invalid'
                                        }
                                    ...
                                    <input
                                        type="text"
                                        className={
                                            testOkay.cancer(sampleConfig)
                                                ? 'menu-text-input'
                                                : 'menu-text-input-invalid'
                                        }
                                    ...
                                    <input
                                        type="text"
                                        className={
                                            testOkay.sv(sampleConfig) ? 'menu-text-input' : 'menu-text-input-invalid'
                                        }
                                        placeholder="https://..."
                                        required
                                    ...
                                    <input
                                        type="text"
                                        className={
                                            testOkay.cnv(sampleConfig) ? 'menu-text-input' : 'menu-text-input-invalid'
                                        }
                                        placeholder="https://..."
                                    ...
                                    <input
                                        type="text"
                                        className={
                                            testOkay.vcf(sampleConfig) ? 'menu-text-input' : 'menu-text-input-invalid'
                                        }
                                        placeholder="https://..."
                                    ...
                                    <input
                                        type="text"
                                        className={
                                            testOkay.vcfIndex(sampleConfig)
                                                ? 'menu-text-input'
                                                : 'menu-text-input-invalid'
                                        }
                                        placeholder="https://..."
                                    ...
                                    <input
                                        type="text"
                                        className={
                                            testOkay.vcf2(sampleConfig) ? 'menu-text-input' : 'menu-text-input-invalid'
                                        }
                                        placeholder="https://..."
                                        onChange={e =>
                                    ...
                                    <input
                                        type="text"
                                        className={
                                            testOkay.vcf2Index(sampleConfig)
                                                ? 'menu-text-input'
                                                : 'menu-text-input-invalid'
                                        }
                                        placeholder="https://..."
                                    ...
                                    <input
                                        type="text"
                                        className={
                                            testOkay.bam(sampleConfig) ? 'menu-text-input' : 'menu-text-input-invalid'
                                        }
                                        placeholder="https://..."
                                    ...
                                    <input
                                        type="text"
                                        className={
                                            testOkay.bai(sampleConfig) ? 'menu-text-input' : 'menu-text-input-invalid'
                                        }
                                        placeholder="https://..."
